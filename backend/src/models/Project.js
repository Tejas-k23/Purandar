...
const projectSchema = new mongoose.Schema(
  {
    ...
    extraConfigurations: { type: [String], default: [] },
    ...
    customContactName: { type: String, trim: true, default: '' },
    customContactPhone: { type: String, trim: true, default: '' },
    customContactEmail: { type: String, trim: true, default: '' },
