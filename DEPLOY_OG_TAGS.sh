#!/bin/bash
# Dynamic OG Tags - Deployment Commands
# Copy and run these commands to deploy the implementation
...
echo ""
echo "✅ Trigger redeploy after adding variables"
echo ""
...
echo "  curl https://purandarprimeproperties.com/api/meta?propertyId=[id]"
echo ""
echo "Option 3: Browser DevTools"
echo "  1. Visit: https://purandarprimeproperties.com/property/[id]"
echo "  2. Open DevTools → Elements"
echo "  3. Check <head> for meta tags with property data"
echo ""

# Step 5: Real Platform Testing
...
echo "  - Backend Endpoint: https://purandar.onrender.com/api/v1/meta/property/[id]"
echo "  - Frontend Endpoint: https://purandarprimeproperties.com/api/meta?propertyId=[id]"
echo "  - Property URL: https://purandarprimeproperties.com/property/[id]"
echo ""
echo "🧪 Testing Tools:"
